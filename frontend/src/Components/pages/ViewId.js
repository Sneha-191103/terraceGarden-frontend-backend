...
<div name="description" value={items.description}><h1 className="jk">{items.description}</h1></div></center>

<div name="rate" value={items.rate}><h2>Price : ₹{items.rate}</h2></div>
                    
                     <div className="cbox">
                    <div className='l1'>
                        <input type="number" name="quantity" value={items.quantity} onChange={handleChange}/>
